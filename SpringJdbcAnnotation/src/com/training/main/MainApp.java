...
public class MainApp {
	public static void main(String[] args) {
		...
		ExamDAO examJDBCTemplate = applicationContext.getBean(ExamDAO.class);
		/*
		 * System.out.println("------Records Creation--------");
		 * examJDBCTemplate.create("2021-12-12", true, "sadasdasdasfsaf");
		 */
		...
		/*
		 * System.out.println("----Listing Record with ID = 2 -----"); Exam record =
		 * examJDBCTemplate.getExam(2); System.out.print("ID : " + record.getId());
		 * System.out.print(", StudentName : " + record.getStudentName());
		 * System.out.println(", Date : " + record.getDate());
		 * System.out.println(", attendence : " + record.isAttendence());
		 * 
		 ...
		 * 
		 * System.out.println("------Listing Multiple Records--------"); List<Exam>
		 * exam1 = examJDBCTemplate.listExam();
		 * 
		 * for (Exam record1 : exam1) { System.out.print("ID : " + record1.getId());
